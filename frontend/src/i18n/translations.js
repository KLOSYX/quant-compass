export const translations = {
    zh: {
        ...
        robust_score: '稳健分数',
        asset_diagnostics_title: '资产诊断',
        asset_diagnostics_note: '累计收益高不等于一定进入前沿；优化器同时看收益、波动、相关性和相对 RiskFree 的超额收益。',
        diag_col_total_return: '样本累计',
        diag_col_cagr: '样本年化',
        diag_col_optimizer_return: '优化年化',
        diag_col_volatility: '样本波动',
        diag_col_frontier_use: '前沿参与',
        diag_col_max_weight: '最高权重',
        diag_col_diagnosis: '诊断',
        diag_reason_risk_free_anchor: '显式无风险锚点',
        diag_reason_selected_on_frontier: '已进入前沿',
        diag_reason_below_risk_free: '优化预期收益不高于 RiskFree',
        diag_reason_dominated_by_higher_sharpe_assets: '单位风险超额收益不占优，被 RiskFree + 更高 Sharpe 资产替代',
        diag_reason_unused_in_sample: '当前样本协方差下未改善前沿',
        diag_sharpe_rank: 'Sharpe 排名',
    ...
    en: {
        ...
        asset_diagnostics_title: 'Asset Diagnostics',
        asset_diagnostics_note: 'A high trailing return does not guarantee frontier inclusion. The optimizer also compares return, volatility, correlation, and excess return over RiskFree.',
        diag_col_total_return: 'Trailing Return',
        diag_col_cagr: 'Sample CAGR',
        diag_col_optimizer_return: 'Optimizer Return',
        diag_col_volatility: 'Sample Vol',
        diag_col_frontier_use: 'Frontier Usage',
        diag_col_max_weight: 'Max Weight',
        diag_col_diagnosis: 'Diagnosis',
        diag_reason_risk_free_anchor: 'Explicit risk-free anchor',
        diag_reason_selected_on_frontier: 'Included on the frontier',
        diag_reason_below_risk_free: 'Optimizer return is not above RiskFree',
        diag_reason_dominated_by_higher_sharpe_assets: 'Inferior excess return per unit of risk; replaced by RiskFree plus higher-Sharpe assets',
        diag_reason_unused_in_sample: 'Did not improve the frontier under the current sample covariance',
        diag_sharpe_rank: 'Sharpe rank',
